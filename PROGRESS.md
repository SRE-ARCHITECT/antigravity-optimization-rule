...
- [x] Atualização da regra global `GEMINI.md` para v2.0 com:
  - Edições cirúrgicas por blocos/diffs.
  - Bloqueio de daemons autônomos e compilação em background (Android/Gradle/npm/pip/cargo).
